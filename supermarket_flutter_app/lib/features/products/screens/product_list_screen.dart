...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final base = (injected != null && injected.isNotEmpty)
        ? injected
    ...
    if (productProvider.error != null) {
      ...
      final userFriendlyMsg = errorMsg.contains('SocketException')
          ...
          : errorMsg
                .replaceAll(RegExp(r'Exception:|ClientException:'), '')
                .trim();
      return Center(
        child: Card(
          elevation: 2,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Viewing injected POS results (${injected.length})',
                ...
                Padding(
                  ...
                  child: Row(
                    children: const [
                      ...
                      SizedBox(width: 8),
                      Text(
                        'Demo data — items seeded locally',
                    ...
                    return Scrollbar(
                      ...
                      child: GridView.builder(
                        ...
                        gridDelegate: (() {
                          ...
                          if (itemWidth < 280) {
                            desiredHeight =
                                300; // narrow columns -> taller cards (vertical layout)
                          } else if (itemWidth < 360) {
                            desiredHeight = 200; // medium columns
                          } else {
                            desiredHeight =
                                160; // wide columns -> compact horizontal cards
                          }
                        ...
                        child: AspectRatio(
                          ...
                          child: (() {
                            ...
                            if (imageUrl != null &&
                              ...
                              imageUrl =
                                  'https://supermarket-api-2lx7.onrender.com$imageUrl';
                            }
                            final heroTag =
